...
// مكون Header يعرض شريط الترويسة العلوي مع اسم الموقع وقائمة التنقل ومحدد اللغة
    ...
    <header className="sticky top-0 z-50 bg-[#1a1917]/95 border-b border-[#d4af37]/30 p-6 flex justify-between items-center shadow-lg">
        ...
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex items-center gap-6">
            {/* تكرار أقسام المحتوى لإنشاء روابط التنقل */}
            {Data(lang)[1].map(sec => (
          ...
          <select
            value={lang}
            // عند تغيير اللغة، يتم تحديث حالة اللغة في المكون الأب
